...
int add_paragraph_after(Document *doc, int paragraph_number){
  if(doc == NULL || doc->number_of_paragraphs == MAX_PARAGRAPHS
     || paragraph_number > (MAX_PARAGRAPHS - doc->number_of_paragraphs)){
    return FAILURE;
  }
...
/*The function will add the first data lines number of lines from the data array to the document*/
